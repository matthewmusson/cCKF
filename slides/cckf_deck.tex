...
\begin{figure}
    ...
    \caption{Window Failure Rate across $\eta$ stratified by occupancy}
    \label{fig:placeholder}
\end{figure}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item The grid is coarse and has not reached the low-fake corner of
        threshold space.
      \item Greedy ambiguity resolution still stands in for the planned
        set-packing ILP, whose job is to remove exactly these surviving
        fakes.
    \end{itemize}
...
\begin{frame}{Next Week}
  \begin{itemize}
    ...
    \item Wire the set-packing ILP into ambiguity resolution and remeasure
      the fake rate.
  \end{itemize}
\end{frame}
