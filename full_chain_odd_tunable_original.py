...
parser.add_argument(
    "--sf_collisionZMin",
    help="Minimum Z for collision region (mm)",
    type=float,
    default=-250.0,
)
...
parser.add_argument(
    "--sf_collisionZMax",
    help="Maximum Z for collision region (mm)",
    type=float,
    default=250.0,
)
...
parser.add_argument(
    "--sf_zMin",
    help="Minimum Z for seed finding (mm)",
    type=float,
    default=-2000.0,
)
...
parser.add_argument(
    "--sf_zMax",
    help="Maximum Z for seed finding (mm)",
    type=float,
    default=2000.0,
)
...
parser.add_argument(
    "--sf_rMin",
    dest="sf_r_min",
    help="Minimum R for seeding (mm)",
    type=float,
    default=0.0,  # Or set to None if you really want unbounded
)

parser.add_argument(
    "--sf_rMax",
    dest="sf_r_max",
    help="Maximum R for seeding (mm)",
    type=float,
    default=200.0,
)
...
# ----------------------------------------------------------------------------
# Construct SeedFinderConfig using the CLI flags
# ----------------------------------------------------------------------------
seedFinderCfg = SeedFinderConfigArg(
    r=(
        args.sf_r_min * u.mm,
        args.sf_r_max * u.mm,
    ),
    deltaR=(
        args.sf_deltaRMin * u.mm,
        args.sf_deltaRMax * u.mm,
    ),
    collisionRegion=(
        args.sf_collisionZMin * u.mm,
        args.sf_collisionZMax * u.mm,
    ),
    z=(
        args.sf_zMin * u.mm,
        args.sf_zMax * u.mm,
    ),
    minPt=args.sf_minPt * u.GeV,
    ...
    maxPtScattering=args.sf_maxPtScattering * u.GeV,
